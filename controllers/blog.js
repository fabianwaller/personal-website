...
const createArticle = (con) => (req, res) => {
    let categorie = 'money';
    let content = `<h2 data-heading=\"\"book summary\"\">book summary</h2>
    <blockquote>
    ...
    <em>margin of safety</em> — is on of the most underappreciated forces in finance.</p>
    </blockquote>
    ...
    behave under stress, and how they respond to incentives tend to be stable in time).</p>
    ...
    `
    let text = "timeless lessons on wealth, greed and happiness"
    let title = 'the psychology of money'
    let imageurl = "pom.png"
    let slug = 'psychologyofmoneysummary6'
