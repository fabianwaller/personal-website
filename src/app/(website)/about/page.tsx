...
const Keyword = ({ children }: { children: React.ReactNode }) => (
  <span className="inline-block rounded-lg px-4 py-2 text-sm text-title-normal shadow-custom-soft">
    {children}
  </span>
);
        ...
        <div>
          <ScrollAnimated>
            <p className="leading-relaxed">
              ...
              mobile development, as well as software engineering and artificial
