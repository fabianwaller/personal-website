    ...
    return (
        <a href="/" className="flex items-center text-title-normal">
            <svg className="h-8 w-8 mr-1" width="78" height="74" viewBox="0 0 78 74" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path className={white ? "fill-white" : "fill-primary-foreground"} d="M33.9973 43.1746L8.6036 25.3937V25.3937C18.4237 11.3691 37.7536 7.96074 51.7782 17.7808V17.7808L33.9973 43.1746Z" />
                <path className={white ? "fill-white" : "fill-primary-foreground"} d="M64.0656 26.3848C59.3139 33.1709 49.9607 34.8201 43.1746 30.0685V30.0685L51.7783 17.7812L64.0656 26.3848V26.3848Z" />
            </svg>
